        ...
        <div className="postCardFooter">
          ...
          <section className="comments">
            <div className="postDescription">
              <h4>runner</h4>
              <p>
                Every person remembers some moment in their life where they witnessed some injustice, big or
                small, and looked away because the consequences of intervening seemed too intimidating. But
                there’s a limit to the amount of incivility and inequality and inhumanity that each individual
                can tolerate.
              </p>
            </div>
